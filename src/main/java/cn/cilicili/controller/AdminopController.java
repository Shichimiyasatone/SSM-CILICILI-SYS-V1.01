package cn.cilicili.controller;
...
import cn.cilicili.entity.JsonResult;
...
import cn.cilicili.utils.GetImgUrl;
import cn.cilicili.utils.MD5Util;
...
public class AdminopController {
	...
	public String delvbys( @PathVariable int sid,Model model) {
		...
		System.out.println("id = "+v.get(0).getVideoid());
